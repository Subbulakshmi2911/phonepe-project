...
#sql connection
mydb = mysql.connector.connect(user='root', password='root', host='localhost',database='phonepe')
cursor = mydb.cursor()
...
if select == "Home":
    ...
    with col2:
        st.image(Image.open(r"/content/pulse/image2.JPG"),width= 450)

    col3,col4= st.columns(2)
    
    with col3:
         st.image(Image.open(r"/content/pulse/image1.PNG"),width=300)
    ...
    with col6:
        st.video("/content/pulse/4109600-uhd_3840_2160_25fps.mp4")
